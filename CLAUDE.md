...
- **Next up:** Phase 1B of `docs/refactor-plan.md` (metric registry refactor + parity protocol) — FRESH SESSION required (context rule); user to visually verify dashboard "With metrics" count (~247) and rollup chips after the 1A Vercel deploy first
