...
const MD = {
  ...
  inboundCallsOffered: "60000000-0000-4000-8000-000000000011",
  inboundCallsAccepted: "60000000-0000-4000-8000-000000000012",
  inboundCallsAbandonedOnHold: "60000000-0000-4000-8000-000000000013",
  avgTalkTimeInbound: "60000000-0000-4000-8000-000000000014",
  avgHoldTimeInbound: "60000000-0000-4000-8000-000000000015",
  avgCallDurationInbound: "60000000-0000-4000-8000-000000000016",
  avgConsultationTimeInbound: "60000000-0000-4000-8000-000000000017",
  outboundCalls: "60000000-0000-4000-8000-000000000018",
  outboundCallsCompleted: "60000000-0000-4000-8000-000000000019",
  outboundCallsNonAnswered: "60000000-0000-4000-8000-00000000001a",
  avgTalkTimeOutbound: "60000000-0000-4000-8000-00000000001b",
  avgHoldTimeOutbound: "60000000-0000-4000-8000-00000000001c",
};
...
async function seed() {
  ...
  await db.transaction(async (tx) => {
    ...
    await tx.insert(metricDefinitions).values([
      ...
      {
        id: MD.inboundCallsOffered,
        organizationId: ORG_ID,
        key: "inbound_calls_offered",
        name: "IB (Inbound)",
        description: "Number of inbound calls offered during the period",
      ...
      {
        id: MD.inboundCallsAccepted,
        organizationId: ORG_ID,
        key: "inbound_calls_accepted",
        name: "Accepted IB (Inbound)",
        description: "Number of inbound calls accepted/completed during the period",
        category: "inbound_call",
        unit: "calls",
        valueType: "count",
        direction: "higher_is_better",
      ...
      {
        id: MD.inboundCallsAbandonedOnHold,
        organizationId: ORG_ID,
        key: "inbound_calls_abandoned_on_hold",
        name: "Abandoned on Hold",
        description: "Number of inbound calls the caller abandoned while on hold",
        category: "inbound_call",
        unit: "calls",
        valueType: "count",
        direction: "lower_is_better",
      ...
      {
        id: MD.avgTalkTimeInbound,
        organizationId: ORG_ID,
        key: "avg_talk_time_inbound",
        name: "Avg Talk",
        description: "Average talk time for inbound calls, in seconds",
        category: "inbound_call",
        unit: "s",
        valueType: "duration",
        direction: "neutral",
      ...
      {
        id: MD.avgHoldTimeInbound,
        organizationId: ORG_ID,
        key: "avg_hold_time_inbound",
        name: "Avg Hold",
        description: "Average hold time for inbound calls, in seconds",
        category: "inbound_call",
        unit: "s",
        valueType: "duration",
        direction: "lower_is_better",
      ...
      {
        id: MD.avgCallDurationInbound,
        organizationId: ORG_ID,
        key: "avg_call_duration_inbound",
        name: "Avg Duration",
        description: "Average total duration for inbound calls, in seconds",
        category: "inbound_call",
        unit: "s",
        valueType: "duration",
        direction: "neutral",
      ...
      {
        id: MD.avgConsultationTimeInbound,
        organizationId: ORG_ID,
        key: "avg_consultation_time_inbound",
        name: "Avg Consultation",
        description: "Average consultation time for inbound calls that had one, in seconds",
        category: "inbound_call",
        unit: "s",
        valueType: "duration",
        direction: "neutral",
      ...
      },
      {
        ...
        key: "outbound_calls",
        name: "OB (Outbound)",
        description: "Number of outbound calls made during the period",
      ...
      {
        id: MD.outboundCallsCompleted,
        organizationId: ORG_ID,
        key: "outbound_calls_completed",
        name: "Completed OB (Outbound)",
        description: "Number of outbound calls completed during the period",
        category: "outbound_call",
        unit: "calls",
        valueType: "count",
        direction: "higher_is_better",
      ...
      {
        id: MD.outboundCallsNonAnswered,
        organizationId: ORG_ID,
        key: "outbound_calls_non_answered",
        name: "Non-answered OB (Outbound)",
        description: "Number of outbound call attempts that failed to connect",
        category: "outbound_call",
        unit: "calls",
        valueType: "count",
        direction: "lower_is_better",
      ...
      {
        id: MD.avgTalkTimeOutbound,
        organizationId: ORG_ID,
        key: "avg_talk_time_outbound",
        name: "Avg Talk",
        description: "Average talk time for outbound calls, in seconds",
        category: "outbound_call",
        unit: "s",
        valueType: "duration",
        direction: "neutral",
      ...
      {
        id: MD.avgHoldTimeOutbound,
        organizationId: ORG_ID,
        key: "avg_hold_time_outbound",
        name: "Avg Hold",
        description: "Average hold time for outbound calls, in seconds",
        category: "outbound_call",
        unit: "s",
        valueType: "duration",
        direction: "lower_is_better",
    ...
    const callMetrics = [
      MD.inboundCallsOffered,
      MD.inboundCallsAccepted,
      MD.inboundCallsAbandonedOnHold,
      MD.avgTalkTimeInbound,
      MD.avgHoldTimeInbound,
      MD.avgCallDurationInbound,
      MD.avgConsultationTimeInbound,
      MD.outboundCalls,
      MD.outboundCallsCompleted,
      MD.outboundCallsNonAnswered,
      MD.avgTalkTimeOutbound,
      MD.avgHoldTimeOutbound,
    ];
    ...
    const posMetrics = [
      ...
      ...callMetrics.map((defId, i) => ({ defId, order: 7 + i, primary: false })),
    ];
    ...
    const menufyMetrics = [
      ...
      ...callMetrics.map((defId, i) => ({ defId, order: 6 + i, primary: false })),
    ];
